        ...
        <div className="about-content">
          ...
          <section>
              <div className="d-flex align-items-center">
                <img className="mx-2" src='../img/Phillip.jpeg' alt="picture of phillip chaplin"/>
          ...
          <section>
              <div className="d-flex align-items-center">
                <img className="mx-2" src='../img/DanieImg.jpeg' alt="image of daniel yoon"/>
                <div className="d-flex flex-column px-5">
          ...
          <section>
              <div className="d-flex align-items-center">
                <img className="mx-2" src='../img/Joelmg.jpeg' alt="image of joel myrtil"/>
                <div className="d-flex flex-column px-5">
          ...
          <section>
              <div className="d-flex align-items-center">
                <img className="mx-2" src='../img/ahmedImg.jpeg' alt="image of ahmed mohamed"/>
                <div className="d-flex flex-column px-5">
